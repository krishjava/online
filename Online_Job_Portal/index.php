	...
	<div class="sixteen columns">
		...
		<nav id="navigation" class="menu">
			...
			<ul class="float-right">
				...
				<li><a data-toggle = "modal" data-target = "#signupModal"><i class="fa fa-about" ></i>About US</a></li>
				<li><a data-toggle = "modal" data-target = "#myModal"><i class="fa fa-phone"></i>Contact US</a></li>
			</ul>
